...
function parseEstimoteTelemetryPacket(data) { // data is a 0-indexed byte array/buffer
  ...
  if (subFrameType == ESTIMOTE_TELEMETRY_SUBFRAME_A) {
    ...
    telemetrydata.shortIdentifier = shortIdentifier;
    telemetrydata.protocolVersion = protocolVersion;
    telemetrydata.acceleration = acceleration;
    telemetrydata.isMoving = isMoving;
    telemetrydata.motionStateDuration = motionStateDuration;
    telemetrydata.gpio = gpio;
    telemetrydata.errors = errors;
  ...
  // ****************
    ...
    // console.log({shortIdentifier, protocolVersion, magneticField,
    //   ambientLightLevel, uptime, temperature, batteryVoltage, errors,
    //   batteryLevel});

    telemetrydata.shortIdentifier = shortIdentifier;
    telemetrydata.protocolVersion = protocolVersion;
    telemetrydata.magneticField = magneticField;
    telemetrydata.ambientLightLevel = ambientLightLevel;
    telemetrydata.uptime = uptime;
    telemetrydata.temperature = temperature;
    telemetrydata.batteryVoltage = batteryVoltage;
    telemetrydata.errors = errors;
