...
var ESTIMOTE_SERVICE_UUID_2 = 'fe9f';
var TKR = '0f3e';
var CHARGE_HR = '180a';
...
Beacon.prototype.onDiscover = function(peripheral) {
 ...
 // console.log(peripheral.advertisement);
    ...
    if(peripheral.advertisement.serviceData.length > 0){
        ...
        return el.uuid == ESTIMOTE_SERVICE_UUID || el.uuid == 'fe9f';
      });
      if(servicedata){
        var telemetrydata = telemetry.parseEstimoteTelemetryPacket(servicedata.data);
        if(telemetrydata) 
  ...
  if (manufacturerData &&
    ...
    if ((!this._uuid || this._uuid.indexOf(uuid) != -1 ) &&
      ...
      bleacon.informationType = "Beacon";
